...
public class UtilisateursHome {
	...
	public Utilisateurs findById(java.lang.Integer id) {
		...
		try {
			Utilisateurs instance = (Utilisateurs) sessionFactory.getCurrentSession().get("Utilisateurs", id);
			if (instance == null) {
	...
	public List findByExample(Utilisateurs instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Utilisateurs")
