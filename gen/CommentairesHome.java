...
public class CommentairesHome {
	...
	public Commentaires merge(Commentaires detachedInstance) {
		...
		try {
			Commentaires result = (Commentaires) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Commentaires findById(java.lang.Integer id) {
		...
		try {
			Commentaires instance = (Commentaires) sessionFactory.getCurrentSession().get("Commentaires", id);
			if (instance == null) {
	...
	public List findByExample(Commentaires instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Commentaires")
